<nav>
    <ul class="sidebar">
        ...
        <li class="sections"><a href="https://deliverylions.000webhostapp.com/sitioweb/registro.php">Cerrar Sesión</a></li>
    </ul>
    <ul>
        <li class="logo"><a href="#"><img src="../img/logo.jpg" alt=""></a></li>
        <li class="sections hideOnMobile"><a href="inicioAfiliado.php">Inicio</a></li>
        <li class="sections hideOnMobile"><a href="pedidoAfiliado.php">Pedidos</a></li>
        <li class="sections hideOnMobile"><a href="menuAfiliado.php">Menús</a></li>
        <li class="sections hideOnMobile"><a href="perfilAfiliado.php">Perfil</a></li>
        <li class="sections hideOnMobile"><a href="https://deliverylions.000webhostapp.com/sitioweb/inicioPrincipal.php">Cerrar Sesión</a></li>
